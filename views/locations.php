        ...
        <?php 
            if(isset($_GET["location"])&&$_GET["location"]<=5){
                ...
                <div class="locations">
                    ...
                    <ul>
                        <li>
                            <a href="index.php?action=locations&location=1">
                                <div class="icon"><i class='bx bxs-map'></i></div>
                                4612 Hirschberg Ave Schiller Park, IL 60176 USA
                            </a>
                        </li>
                        <li>
                            <a href="index.php?action=locations&location=2">
                                <div class="icon"><i class='bx bxs-map'></i></div>
                                New York
                            </a>
                        </li>
                        <li>
                            <a href="index.php?action=locations&location=3">
                                <div class="icon"><i class='bx bxs-map'></i></div>
                                Chicago
                            </a>
                        </li>
                        <li>
                            <a href="index.php?action=locations&location=4">
                                <div class="icon"><i class='bx bxs-map'></i></div>
                                Washington
                            </a>
                        </li>
                        <li>
                            <a href="index.php?action=locations&location=5">
                                <div class="icon"><i class='bx bxs-map'></i></div>
                                Indianapolis
                            </a>
                        </li>
